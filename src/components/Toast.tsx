...
const Toast: React.FC<ToastProps> = ({ message, type = 'info', duration = 5000, onClose }) => {
  ...
  const getToastStyles = () => {
    const baseStyles =
      'fixed top-4 right-4 z-50 max-w-sm w-full bg-white dark:bg-slate-800 rounded-lg shadow-lg border p-4 transition-all duration-300 transform';
